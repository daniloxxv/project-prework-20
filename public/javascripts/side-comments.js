...
require.register("side-comments/js/main.js", function(
   ...
   */
  SideComments.prototype.removeComment = function(
    sectionId,
    commentId,
    parentId
  ) {
   ...
   */
  SideComments.prototype.deleteComment = function(
    sectionId,
    commentId,
    parentId
  ) {
...
require.register("side-comments/js/section.js", function(
  ...
  function Section(eventPipe, $el, currentUser, comments) {
    ...
    this.$el.on(
      this.clickEventName,
      ".side-comment .reply-comment",
      _.bind(this.replyCommentClick, this)
    );
    this.$el.on(
      this.clickEventName,
      ".side-comment .post",
  ...
  Section.prototype.showCommentForm = function() {
    ...
    if ((currentUser.avatarUrl = "")) {
      currentUser.avatarUrl = "/images/placeholder2.png";
    }
  ...
  Section.prototype.showReplyForm = function(replyButton) {
    if (this.comments.length > 0) {
      ...
      $form = $(
        _.find($.makeArray(this.$el.find(".reply-form")), function(el) {
          return el.dataset.parent === replyButton.dataset.comment;
        })
      );
  ...
  Section.prototype.postComment = function() {
    ...
    var $commentBox = $commentForm.find(".comment-box"),
      ...
      comment = {
        ...
        comment: commentBody,
        authorAvatarUrl:
          this.currentUser.avatarUrl || "/images/placeholder2.png",
  ...
  Section.prototype.insertComment = function(comment) {
    ...
    if (comment.parentId !== undefined) {
      ...
      $parent = $(
        _.find($.makeArray(this.$el.find(".comments > li")), function(el) {
          return el.dataset.commentId == comment.parentId;
        })
      );
  ...
  Section.prototype.removeComment = function(commentId, parentId) {
    if (parentId != null) {
      ...
      this.$el
        .find(
          '.side-comment .comments > li[data-comment-id="' +
            parentId +
            '"] .replies li[data-comment-id="' +
            commentId +
            '"]'
        )
        .remove();
      ...
      if (comment.replies.length > 0) {
        ...
        this.$el
          .find(
            '.side-comment .comments li[data-comment-id="' + commentId + '"]'
          )
          .remove();
        this.updateCommentCount();
      }
