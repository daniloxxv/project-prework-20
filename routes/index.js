...
//authentication routes
  ...
  .post('/signup', (req, res, next)=>{
    ...
    if (/[^a-zA-Z0-9]/.test(req.body.password)){
      ...
      let passwordError = "Please include at least one number and one capital letter."
      res.render('auth/signup', {passwordError})
      return
    }
    else if (!/^[a-zA-Z0-9]{6,20}$/.test(req.body.password)){
      let passwordError = "Your password should have between 6 and 20 characters."
      res.render('auth/signup', {passwordError})
      return
    }
